...
class StationDisplay:
    def __init__(self, window: Tk, screen_width:int, screen_height:int, station: Station, points: int):
...
self.c.create_text(5*self.width/8, (5*(self.height-110)/6)+125, fill='black', font='Arial 25', text='No', anchor='center')
    ...
    def change_tab(self):
        ...
        match self.page:
            case 0: self.assemble_passenger_page()
            case 1: self.assemble_exit_page()
