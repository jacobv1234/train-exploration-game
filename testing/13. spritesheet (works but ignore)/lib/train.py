...
from lib.helper import opp_dir, get_part_image
...
class Train():
    ...
    def __init__(self, startx, starty, startdir, start_line, c, skin):
        ...
        # load graphics
        spritesheet = PhotoImage(file=f'./graphics/skins/{skin}.png')
        self.graphics = []
        for i in range(16):
            row = i % 4
            column = i // 4
            ...
            self.graphics.append(get_part_image(spritesheet,row,column,row+49,column+49))
